package feathers.themes
{
	...
	public class IconMobileTheme extends DisplayListWatcher
	{
		[Embed(source="/../assets/images/icon.png")]
		protected static const ATLAS_IMAGE:Class;

		[Embed(source="/../assets/images/icon.xml",mimeType="application/octet-stream")]
		...
		public static const PAGE_HEADER:String = "page-header";
		...
		public function IconMobileTheme(root:DisplayObjectContainer, scaleToDPI:Boolean = true)
		{
			super(root)
		...
		public var smallUIDarkTextFormat:TextFormat;
		...
		protected var textfieldSkinTextures:Scale9Textures;
		protected var textfieldDisabledSkinTextures:Scale9Textures;
		protected var textfieldFocusedSkinTextures:Scale9Textures;
		...
		protected var backButtonUpSkinTextures:Scale9Textures;
		protected var backButtonDownSkinTextures:Scale9Textures;
		...
		public var iconBlankTexture:Texture;
		public var iconCompleteTexture:Texture;
		public var iconKitchenTexture:Texture;
		...
		protected function initialize():void
		{
			...
			this.headerTextFormat = new TextFormat(fontNames, Math.round(32 * this.scale), LIGHT_TEXT_COLOR, true);
			...
			this.headerSkinTexture = this.atlas.getTexture("header-skin");
			
			const textfieldSkinTexture:Texture = this.atlas.getTexture("textfield-skin");
			const textfieldDisabledSkinTexture:Texture = this.atlas.getTexture("textfield-disabled-skin");
			const textfieldFocusedSkinTexture:Texture = this.atlas.getTexture("textfield-focused-skin");
			
			this.textfieldSkinTextures = new Scale9Textures(textfieldSkinTexture, new Rectangle(12, 12, 104, 34));
			this.textfieldDisabledSkinTextures = new Scale9Textures(textfieldDisabledSkinTexture, new Rectangle(12, 12, 104, 34));
			this.textfieldFocusedSkinTextures = new Scale9Textures(textfieldFocusedSkinTexture, new Rectangle(12, 12, 104, 34));
			...
			this.backButtonUpSkinTextures = new Scale9Textures(this.atlas.getTexture("backbutton-up-skin"), new Rectangle(24, 0, 32, 64));
			this.backButtonDownSkinTextures = new Scale9Textures(this.atlas.getTexture("backbutton-down-skin"), new Rectangle(24, 0, 32, 64));
			
			this.buttonUpSkinTextures = new Scale9Textures(this.atlas.getTexture("button-up-skin"), new Rectangle(18, 12, 10, 22));
			this.buttonDownSkinTextures = new Scale9Textures(this.atlas.getTexture("button-down-skin"), new Rectangle(18, 12, 10, 22));
			this.buttonDisabledSkinTextures = new Scale9Textures(this.atlas.getTexture("button-disabled-skin"), new Rectangle(18, 12, 10, 22));
			...
			this.iconBlankTexture = this.atlas.getTexture("icon-blank-texture");
			this.iconCompleteTexture = this.atlas.getTexture("icon-complete-texture");
			this.iconKitchenTexture = this.atlas.getTexture("icon-kitchen-texture");
			...
			this.setInitializerForClass(Label, pageHeaderInitializer, PAGE_HEADER);
			...
			this.setInitializerForClass(Button, backButtonInitializer, BACK_BUTTON);
		...
		{
			const skinSelector:Scale9ImageStateValueSelector = new Scale9ImageStateValueSelector();
			skinSelector.defaultValue = this.backButtonUpSkinTextures;
			skinSelector.setValueForState(this.backButtonDownSkinTextures, Button.STATE_DOWN, false);
			skinSelector.imageProperties =
			{
				width: 64 * this.scale,
			...
			button.defaultLabelProperties.textFormat = smallUILightTextFormat;
			button.downLabelProperties.textFormat = smallUIDarkTextFormat;
			
			button.paddingTop = button.paddingBottom = 8 * this.scale;
			button.paddingLeft = 24 * this.scale;
			button.paddingRight = 16 * this.scale;
		...
		protected function pageHeaderInitializer(label:Label):void
		{
		...
		{
			text.textFormat = this.smallDarkTextFormat;
		...
		protected function buttonInitializer(button:Button):void
		{
			...
			{
				width: 46 * this.scale,
				height: 46 * this.scale,
				textureScale: this.scale
			};
			button.stateToSkinFunction = skinSelector.updateValue;

			button.defaultLabelProperties.textFormat = this.smallUIDarkTextFormat;
			button.downLabelProperties.textFormat = this.smallUILightTextFormat;
		...
		protected function itemRendererInitializer(renderer:BaseDefaultItemRenderer):void
		{
			...
			renderer.paddingLeft = 16 * this.scale;
		...
		protected function checkInitializer(check:Check):void
		{
			...
			check.defaultLabelProperties.textFormat = this.smallUIDarkTextFormat;
		...
		{
			const backgroundSkin:Scale9Image = new Scale9Image(this.textfieldSkinTextures, this.scale);
			backgroundSkin.width = 128 * this.scale;
			backgroundSkin.height = 64 * this.scale;
			input.backgroundSkin = backgroundSkin;

			const backgroundDisabledSkin:Scale9Image = new Scale9Image(this.textfieldDisabledSkinTextures, this.scale);
			backgroundDisabledSkin.width = 128 * this.scale;
			backgroundDisabledSkin.height = 64 * this.scale;
			input.backgroundDisabledSkin = backgroundDisabledSkin;

			const backgroundFocusedSkin:Scale9Image = new Scale9Image(this.textfieldFocusedSkinTextures, this.scale);
			backgroundFocusedSkin.width = 128 * this.scale;
			backgroundFocusedSkin.height = 64 * this.scale;
			input.backgroundFocusedSkin = backgroundFocusedSkin;

			input.minWidth = input.minHeight = 64 * this.scale;
			input.minTouchWidth = input.minTouchHeight = 88 * this.scale;
			input.paddingTop = 14 * this.scale;
			input.paddingBottom = 16 * this.scale;
			input.paddingLeft = input.paddingRight = 16 * this.scale;
			input.textEditorProperties.fontFamily = "Helvetica";
			input.textEditorProperties.fontSize = 30 * this.scale;
			input.textEditorProperties.textHeight = 30;
		...
		protected function headerInitializer(header:Header):void
		{
			...
			const backgroundSkin:TiledImage = new TiledImage(this.headerSkinTexture);
			backgroundSkin.width = root.stage.stageWidth;
		...
		public function getIcon(object:Object):Texture
		{
			var texture:Texture = iconBlankTexture;
			
			if(object.complete)
			{
				texture = iconCompleteTexture;
			}
			else
			{
				switch(object.icon)
