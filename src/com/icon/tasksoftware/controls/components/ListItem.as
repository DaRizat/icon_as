package com.icon.tasksoftware.controls.components
{
	...
	public class ListItem extends DefaultListItemRenderer
	{
		...
		override protected function commitData():void
		{
			...
			if(_data)
			{
				itemLabel.text = TaskSoftwareModel(_data).name;
				object_id = TaskSoftwareModel(_data).id;
			}
			else
			{
				itemLabel.text = "";
